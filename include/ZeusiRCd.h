...
public:
  ...
  void check_timeout(const std::shared_ptr<WebUser> new_session, const boost::system::error_code& error);
...
public:
  ...
  void check_timeout(const std::shared_ptr<SSLUser> new_session, const boost::system::error_code& error);
