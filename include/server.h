...
class Server {
    ...
    private:
        ...
        void    startAccept();
        void    handleAccept(const std::shared_ptr<User> newclient, const boost::system::error_code& error);
        void	handle_handshake(const std::shared_ptr<User>& newclient, const boost::system::error_code& error);
