...
public:
	...
	*/
	...
	std::shared_ptr<SocketAddress> GetClientRemoteAddress();
	...
	*/
	...
	std::shared_ptr<SocketAddress> GetRemoteSocketAddress();
...
private:
	...
	std::shared_ptr<SocketAddress> m_client_remote_address; ///< Address of last connect()
	std::shared_ptr<SocketAddress> m_remote_address; ///< Remote end address
